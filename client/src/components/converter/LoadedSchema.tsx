                    ...
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            <div className="form-inline">
                                ...
                                <Input type="file" id="schema-file" name="schema-file" className={`form-control px-1 py-1 ${selectedFile == 'file' ? '' : ' d-none'}`} accept=".jadn" value={uploadedFile} onChange={onFileChange} />                                                                 
                                <Button id='validateJADNButton' className="mx-2" color='success'onClick={onValidateJADNClick}>Validate JADN</Button>
                                <Button id='formatButton' color='info' onClick={onFormatClick}

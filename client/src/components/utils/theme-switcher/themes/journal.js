...
@font-face {
	...
	font-style: normal;
	font-weight: 400;
	src: local('News Cycle'), local('NewsCycle'), url('/assets/fonts/NewsCycle.ttf') format('truetype');
}
@font-face {
	font-family: 'News Cycle';
	font-style: normal;
	font-weight: 700;
	src: local('News Cycle Bold'), local('NewsCycle-Bold'), url('/assets/fonts/NewsCycle-Bold.ttf') format('truetype');
}
...
.custom-select:focus {
	border-color: #fad6d5;
	outline: 0;
	-webkit-box-shadow: 0 0 0 0.2rem rgba(250, 214, 213, 0.5);
	box-shadow: 0 0 0 0.2rem rgba(250, 214, 213, 0.5);
}

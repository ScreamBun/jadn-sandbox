...
.was-validated .custom-control-input:valid:checked ~ .custom-control-label::before, .custom-control-input.is-valid:checked ~ .custom-control-label::before {
	background: #35c9be -webkit-gradient(linear, left top, left bottom, from(#2db2aa), to(#35c9be)) repeat-x;
...
.was-validated .custom-control-input:invalid:checked ~ .custom-control-label::before, .custom-control-input.is-invalid:checked ~ .custom-control-label::before {
	background: #dc609c -webkit-gradient(linear, left top, left bottom, from(#bb588d), to(#dc609c)) repeat-x;
...
.btn-primary {
	color: #fff;
	background: #B58900 -webkit-gradient(linear, left top, left bottom, from(#9a7b08), to(#B58900)) repeat-x;
...
.btn-primary:hover {
	color: #fff;
	background: #8f6c00 -webkit-gradient(linear, left top, left bottom, from(#796208), to(#8f6c00)) repeat-x;
...
.btn-secondary:hover {
	color: #fff;
	background: #6f8183 -webkit-gradient(linear, left top, left bottom, from(#5f7478), to(#6f8183)) repeat-x;
...
.btn-success {
	color: #fff;
	background: #2AA198 -webkit-gradient(linear, left top, left bottom, from(#248f89), to(#2AA198)) repeat-x;
...
.btn-success:hover {
	color: #fff;
	background: #22837b -webkit-gradient(linear, left top, left bottom, from(#1d7671), to(#22837b)) repeat-x;
...
.btn-warning {
	color: #fff;
	background: #CB4B16 -webkit-gradient(linear, left top, left bottom, from(#ad461b), to(#CB4B16)) repeat-x;
...
.btn-warning:hover {
	color: #fff;
	background: #a83e12 -webkit-gradient(linear, left top, left bottom, from(#8f3b18), to(#a83e12)) repeat-x;
...
.btn-danger {
	color: #fff;
	background: #D33682 -webkit-gradient(linear, left top, left bottom, from(#b33477), to(#D33682)) repeat-x;
...
.btn-danger:hover {
	color: #fff;
	background: #ba296f -webkit-gradient(linear, left top, left bottom, from(#9e2967), to(#ba296f)) repeat-x;
...
.btn-light:hover {
	color: #002B36;
	background: #faebbf -webkit-gradient(linear, left top, left bottom, from(#d5ceab), to(#faebbf)) repeat-x;
...
.btn-dark {
	color: #fff;
	background: #073642 -webkit-gradient(linear, left top, left bottom, from(#063440), to(#073642)) repeat-x;
...
.btn-dark:hover {
	color: #fff;
	background: #031a1f -webkit-gradient(linear, left top, left bottom, from(#031c23), to(#031a1f)) repeat-x;
...
.dropdown-item:hover, .dropdown-item:focus {
	...
	text-decoration: none;
	background: #002B36 -webkit-gradient(linear, left top, left bottom, from(#002b36), to(#002B36)) repeat-x;
...
.custom-select {
	...
	color: #495057;
	vertical-align: middle;
	background: #A9BDBD url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 4 5'%3E%3Cpath fill='%23073642' d='M2 0L0 2h4zm0 5L0 3h4z'/%3E%3C/svg%3E") no-repeat right 0.75rem center;
...
.custom-select:focus {
	border-color: #1394b5;
	outline: 0;
	-webkit-box-shadow: 0 0 0 0.2rem rgba(19, 148, 181, 0.5);
...
.custom-range::-webkit-slider-thumb:active {
	background: #18bae3 -webkit-gradient(linear, left top, left bottom, from(#14a5c9), to(#18bae3)) repeat-x;
...
.alert-primary {
	color: #5e4700;
	background: #f0e7cc -webkit-gradient(linear, left top, left bottom, from(#cccbb6), to(#f0e7cc)) repeat-x;
...
.alert-secondary {
	color: #444d4e;
	background: #e6eaea -webkit-gradient(linear, left top, left bottom, from(#c4cdcf), to(#e6eaea)) repeat-x;
...
.alert-info {
	color: #14486d;
	background: #d4e8f6 -webkit-gradient(linear, left top, left bottom, from(#b4ccd9), to(#d4e8f6)) repeat-x;
...
.alert-warning {
	color: #6a270b;
	background: #f5dbd0 -webkit-gradient(linear, left top, left bottom, from(#d0c1b9), to(#f5dbd0)) repeat-x;
...
.alert-danger {
	color: #6e1c44;
	background: #f6d7e6 -webkit-gradient(linear, left top, left bottom, from(#d1bdcc), to(#f6d7e6)) repeat-x;
...
.alert-light {
	color: #848076;
	background: #fffdf9 -webkit-gradient(linear, left top, left bottom, from(#d9dedc), to(#fffdf9)) repeat-x;
...
.alert-dark {
	color: #041c22;
	background: #cdd7d9 -webkit-gradient(linear, left top, left bottom, from(#aebdc1), to(#cdd7d9)) repeat-x;
...
.bg-gradient-primary {
	background: #B58900 -webkit-gradient(linear, left top, left bottom, from(#9a7b08), to(#B58900)) repeat-x !important;
	background: #B58900 linear-gradient(180deg, #9a7b08, #B58900) repeat-x !important;
}

.bg-gradient-secondary {
	background: #839496 -webkit-gradient(linear, left top, left bottom, from(#6f8488), to(#839496)) repeat-x !important;
	background: #839496 linear-gradient(180deg, #6f8488, #839496) repeat-x !important;
}

.bg-gradient-success {
	background: #2AA198 -webkit-gradient(linear, left top, left bottom, from(#248f89), to(#2AA198)) repeat-x !important;
	background: #2AA198 linear-gradient(180deg, #248f89, #2AA198) repeat-x !important;
}

.bg-gradient-info {
	background: #268BD2 -webkit-gradient(linear, left top, left bottom, from(#207dbb), to(#268BD2)) repeat-x !important;
	background: #268BD2 linear-gradient(180deg, #207dbb, #268BD2) repeat-x !important;
}

.bg-gradient-warning {
	background: #CB4B16 -webkit-gradient(linear, left top, left bottom, from(#ad461b), to(#CB4B16)) repeat-x !important;
	background: #CB4B16 linear-gradient(180deg, #ad461b, #CB4B16) repeat-x !important;
}

.bg-gradient-danger {
	background: #D33682 -webkit-gradient(linear, left top, left bottom, from(#b33477), to(#D33682)) repeat-x !important;
	background: #D33682 linear-gradient(180deg, #b33477, #D33682) repeat-x !important;
}

.bg-gradient-light {
	background: #FDF6E3 -webkit-gradient(linear, left top, left bottom, from(#d7d8c9), to(#FDF6E3)) repeat-x !important;
	background: #FDF6E3 linear-gradient(180deg, #d7d8c9, #FDF6E3) repeat-x !important;
}

.bg-gradient-dark {
	background: #073642 -webkit-gradient(linear, left top, left bottom, from(#063440), to(#073642)) repeat-x !important;
...
.btn-primary {
	background: #B58900 -webkit-gradient(linear, left top, left bottom, from(#c09b26), to(#B58900)) repeat-x;
	background: #B58900 linear-gradient(180deg, #c09b26, #B58900) repeat-x;
}

.btn-secondary {
	background: #839496 -webkit-gradient(linear, left top, left bottom, from(#96a4a6), to(#839496)) repeat-x;
	background: #839496 linear-gradient(180deg, #96a4a6, #839496) repeat-x;
}

.btn-success {
	background: #2AA198 -webkit-gradient(linear, left top, left bottom, from(#4aafa7), to(#2AA198)) repeat-x;
	background: #2AA198 linear-gradient(180deg, #4aafa7, #2AA198) repeat-x;
}

.btn-info {
	background: #268BD2 -webkit-gradient(linear, left top, left bottom, from(#479cd9), to(#268BD2)) repeat-x;
	background: #268BD2 linear-gradient(180deg, #479cd9, #268BD2) repeat-x;
}

.btn-warning {
	background: #CB4B16 -webkit-gradient(linear, left top, left bottom, from(#d36639), to(#CB4B16)) repeat-x;
	background: #CB4B16 linear-gradient(180deg, #d36639, #CB4B16) repeat-x;
}

.btn-danger {
	background: #D33682 -webkit-gradient(linear, left top, left bottom, from(#da5495), to(#D33682)) repeat-x;
	background: #D33682 linear-gradient(180deg, #da5495, #D33682) repeat-x;
}

.btn-light {
	background: #FDF6E3 -webkit-gradient(linear, left top, left bottom, from(#fdf7e7), to(#FDF6E3)) repeat-x;
	background: #FDF6E3 linear-gradient(180deg, #fdf7e7, #FDF6E3) repeat-x;
}

.btn-dark {
	background: #073642 -webkit-gradient(linear, left top, left bottom, from(#2c545e), to(#073642)) repeat-x;

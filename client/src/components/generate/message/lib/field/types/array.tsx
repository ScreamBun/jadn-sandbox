...
type ArrayFieldConnectedProps = ArrayFieldProps & ConnectorProps;

// Component
const ArrayField: FunctionComponent<ArrayFieldConnectedProps> = props => {
  const {
...
export default connector(ArrayField);

...
export const OutlineItem: FC<OutlineItemProps> = ({ id, text, index, moveCard, dropCard, onClick, isFullCard }) => {
  ...
  >({
    ...
    drop(item: DragItem, _monitor) {
      console.log("OutlineItem item dropped: " + JSON.stringify(item));
      dropCard(item);
    },
  ...
  return (
      <div className='list-group-item' ref={ref} style={{ ...style, opacity }} data-handler-id={handlerId}> 
          <div className='row'>

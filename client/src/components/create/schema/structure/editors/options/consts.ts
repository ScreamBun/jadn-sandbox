...
export const ValidOptions: Record<string, Array<string>> = {
  ...
  // Structures
  Array: ['extends', 'format', 'minLength', 'maxLength', 'ordered/unique', 'set'],
  ...
  Choice: ['id', 'extends', 'combine'],
  Enumerated: ['id', 'enum', 'pointer', 'extends'],
  Map: ['id', 'extends', 'minLength', 'maxLength', 'ordered/unique'],
  MapOf: ['ktype', 'vtype', 'minLength', 'maxLength', 'ordered/unique'],
  Record: ['extends', 'minLength', 'maxLength', 'ordered/unique']
};

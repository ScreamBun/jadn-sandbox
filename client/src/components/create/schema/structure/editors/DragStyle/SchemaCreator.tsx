            ...
            <div className='card-header p-2'>
                <div className='row no-gutters'>
                    ...
                    <div className='col-sm-9'>
                        ...
                        <button type='button' onClick={() => setActiveView('schema')} className={`float-right btn btn-primary btn-sm mr-1 ${activeView == 'schema' ? ' d-none' : ''}`} title="View in JSON">View JSON</button>
                        <button type='button' onClick={() => setActiveView('creator')} className={`float-right btn btn-primary btn-sm mr-1 ${activeView == 'creator' ? ' d-none' : ''}`} title="View via Input Form">View Form</button>
                        {isValidating ? <SBSpinner action={"Validating"} color={"primary"} /> :
                            <button type='button' id='validateJADNButton' className="float-right btn btn-primary btn-sm mr-1" title={isValidJADN ? "JADN is valid" : "Validate JADN"} onClick={onValidateJADNClick}>

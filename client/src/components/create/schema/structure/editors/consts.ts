...
// IPv JADN Fields
export const ipv4_net_address: StandardFieldArray = [1, "ipv4_addr", "Binary", ["/ipv4-addr", "{1"], "IPv4 address as defined in [[RFC0791]](#rfc0791)"]; 
...
export const ipv6_net_address: StandardFieldArray = [1, "ipv6_addr", "Binary", ["/ipv6-addr", "{1"], "IPv6 address as defined in [[RFC8200]](#rfc8200)"];

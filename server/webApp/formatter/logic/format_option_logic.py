...
class FormatOptionLogic:
    ...
    ipv4 = FormatOptionModel("ipv4", "IPv4", "RFC 2673 3.2", FormatType.BINARY.value, "").__dict__
    ipv6 = FormatOptionModel("ipv6", "IPv6", "RFC 4291 2.2", FormatType.BINARY.value, "").__dict__
    ...
    ipv4_net = FormatOptionModel("ipv4-net", "IPv4 Network", "Binary IPv4 address and Integer prefix length as specified in RFC 4632 3.1", FormatType.STRING.value, "").__dict__
    ipv6_net = FormatOptionModel("ipv6-net", "IPv6 Network", "Binary IPv6 address and Integer prefix length as specified in RFC 4291 2.3", FormatType.STRING.value, "").__dict__

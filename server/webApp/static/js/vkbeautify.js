...
*/
/*
 * Not original code from vkBeautify, updated slightly
 */
...
(function() {
	...
	vkbeautify.prototype.sql = function(text, step) {
		var ar_by_quote = text.replace(/\s{1,}/g, " ")
			...
			for (ix=0; ix<len; ix++) {
				ar = ix%2 ? ar.concat(ar_by_quote[ix]) : ar.concat(split_sql(ar_by_quote[ix], tab))
			}
